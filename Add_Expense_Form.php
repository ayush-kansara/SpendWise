...
<body>
    ...
    <nav>
      <div class="mainNav">
        ...
        <div class="navContainer" id="navContainer">
          ...
          <div class="options" id="highlight">ADD EXPENSE</div>
  ...
  <main>
    <div class="contact-form-container">
      <p id="login-heading">ADD EXPENSE</p>
      <p id="sub-heading">
        Log expenses daily for clearer spending insights.
      </p>
      ...
      <form action="Add_Expense.php" method="post">
        <div class="form-element-container">
          ...
          <button type="submit" id="seng-msg-btn" name="addExpenseBtn">Add Expense</button>
        </div>
      </form>
    </div>
  </main>
